...
Rails.application.routes.draw do
    ...
    get '/campaign_finances' => 'campaign_finances#search', :as => :campaign_finances_search
    get '/campaign_finances/search' => 'campaign_finances#show', :as => :campaign_finances_show
end
